...
1. SANGAT PENTING - TANPA LOGO / GAMBAR: Kop Sekolah HANYA berisi teks nama yayasan (jika ada), nama sekolah, alamat lengkap sekolah beserta telepon, dan garis tebal pembatas. DILARANG MENAMBAHKAN TAG <img>, PLACEHOLDER [LOGO], ATAU GAMBAR APAPUN.
...
${schemaKey === "tp" ? `- KHUSUS UNTUK TP: WAJIB memecah (breakdown) paragraf CP dari tiap elemen menjadi beberapa Tujuan Pembelajaran (TP) yang lebih kecil, spesifik, dan operasional. Hasilkan total sekitar 8-12 TP secara keseluruhan. JANGAN HANYA MEMBUAT 1 TP UNTUK 1 ELEMEN! Gunakan prinsip ABCD (Audience, Behavior, Condition, Degree) dan KKO Taksonomi Bloom.` : ""}
