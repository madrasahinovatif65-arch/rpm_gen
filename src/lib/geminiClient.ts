...
${schemaKey === "tp" ? `- KHUSUS UNTUK TP (MIMIC BEST PRACTICE GURU KBC):
  ...
  2. INTEGRASI NILAI DI DALAM KALIMAT TP: Kalimat pada properti "rumusanTp" WAJIB diakhiri dengan frasa tujuan karakter/sikap yang mengambil dari Dimensi Profil Lulusan (DPL) dan Panca Cinta. Contoh format yang benar: "[KKO] [Materi Pokok] ..., untuk menumbuhkan [Nilai DPL] dan mewujudkan [Nilai Panca Cinta]".
